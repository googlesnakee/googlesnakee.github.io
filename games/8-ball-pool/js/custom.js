...
//   document.querySelector('.game-frame').innerHTML = `<iframe src="${document.querySelector('.game-frame').dataset.url}" id="gameframe" frameborder="0" style="height: 570px;width: 750px;"></iframe>`;
// }
function playGame(){
  document.querySelector(".game-frame").innerHTML = `<iframe src="${document.querySelector('#talpa-splash-button').dataset.url}" id="gameframe" frameborder="0" style="height: 480px; width: 750px;"></iframe>`;
}
